...
ggplot(suldio,aes(x = sulfur.dioxide)) +
  geom_histogram(data =free_sd,fill = 'blue',
                 alpha =0.5, binwidth = 5) +
  geom_histogram(data = total_sd, fill = 'red',
                 alpha = 0.5, binwidth = 5) +
...
a wine will be based on a single chemical property. There is no correlation
between any of the 11 variables and quality of wine.
...
graph, we see can see an interesting separation. Those below the trend line are
mostly wines with high quality. Very few low quality wines make it. It makes
sense since we would like white wines to have a lighter taste. When sugar levels
are low, we make up for quality through the lightness of the drink. As sugar
levels rise, the density of the sugar and quality become muddled and there is
